...
class Plugin {
	...
	public static function Settings(GenericEvent $event) {
		...
		$settings->add_text_setting('apisettings', 'softaculous_username', 'Softaculous Username:', 'Softaculous Username', $settings->get_setting('FANTASTICO_USERNAME'));
		$settings->add_text_setting('apisettings', 'softaculous_password', 'Softaculous Password:', 'Softaculous Password', $settings->get_setting('FANTASTICO_PASSWORD'));
		$settings->add_dropdown_setting('stock', 'outofstock_licenses_softaculous', 'Out Of Stock Softaculous Licenses', 'Enable/Disable Sales Of This Type', $settings->get_setting('OUTOFSTOCK_LICENSES_FANTASTICO'), array('0', '1'), array('No', 'Yes', ));
	}
